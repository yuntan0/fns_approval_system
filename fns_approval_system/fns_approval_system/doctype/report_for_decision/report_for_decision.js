...
//	    }
    ...
    before_save: function(frm) {
        ...
        // frm.doc.final_approval = frm.doc.approval_line[eval(frm.doc.approval_line).length-1].employee;
        frm.set_value("final_approval", frm.doc.approval_line[eval(frm.doc.approval_line).length-1].employee);
	},
